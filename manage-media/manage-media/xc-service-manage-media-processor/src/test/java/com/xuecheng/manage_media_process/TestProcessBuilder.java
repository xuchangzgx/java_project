...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testProcessMp4(){
        ...
        //ffmpeg的路径
        String ffmpeg_path = "D:\\development\\environment\\ffmpeg\\bin\\ffmpeg.exe";
        //video_path视频地址
        String video_path =
                "F:\\JAVA\\Java高级教程\\阶段5 容器 微服务\\阶段5 3.微服务项目【学成在线】\\day14 媒资管理\\资料\\solr.avi";
        //mp4_name mp4文件名称
        String mp4_name  ="1.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path="D:\\development\\";
